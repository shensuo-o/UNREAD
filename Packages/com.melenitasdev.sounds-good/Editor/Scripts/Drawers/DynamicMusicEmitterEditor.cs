...
{
    [CustomEditor(typeof(DynamicMusicEmitter))]
    [CanEditMultipleObjects]
    public class DynamicMusicEmitterEditor : UnityEditor.Editor
    {
        private const string DESCRIPTION =
            "Configures a Dynamic Music (layered tracks) from the Inspector, exactly like the code API. " +
            "Reference it to call Play/Pause/Resume/Stop, and use its .DynamicMusic property to blend " +
            "layers or call any Set* method at runtime.";
        ...
        private void BuildBody (VisualElement root)
        {
            ...
            tracksBox.Add(new PropertyField(serializedObject.FindProperty("dynamicTracks"), "Dynamic Tracks"));
            tracksBox.Add(SG_InspectorElements.Slider01(serializedObject, "masterVolume", "Master Volume"));
            root.Add(tracksWrap);
            ...
            root.Add(EmitterEditorUtility.TestButtons(
                Application.isPlaying ? (DynamicMusicEmitter)target : null,
        ...
        public override void OnInspectorGUI ()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("dynamicTracks"), new GUIContent("Dynamic Tracks"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("masterVolume"), new GUIContent("Master Volume"));
