...
{
    [CustomEditor(typeof(MusicEmitter))]
    [CanEditMultipleObjects]
    public class MusicEmitterEditor : UnityEditor.Editor
    {
        private const string DESCRIPTION =
            "Configures a Music track from the Inspector, exactly like the code API. Reference it to " +
            "call Play/Pause/Resume/Stop, and use its .Music property to call any Set* method at runtime.";
        ...
        private void BuildBody (VisualElement root)
        {
            ...
            clipBox.Add(new PropertyField(serializedObject.FindProperty("track"), "Track"));
...
//#SG_PRO_END
            ...
            root.Add(EmitterEditorUtility.TestButtons(
                Application.isPlaying ? (MusicEmitter)target : null,
        ...
        public override void OnInspectorGUI ()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("track"), new GUIContent("Track"));
