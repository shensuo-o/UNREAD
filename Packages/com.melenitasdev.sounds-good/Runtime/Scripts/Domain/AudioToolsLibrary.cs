...
namespace MelenitasDev.SoundsGood.Domain
{
    public partial class AudioToolsLibrary // Properties
    {
        ...
        public OutputDataCollection OutputDataCollection { get; private set; }
    }
    ...
    public partial class AudioToolsLibrary
    {
        ...
        private void Init ()
        {
            try
            {
                ...
                OutputDataCollection = Resources.Load<OutputDataCollection>("Melenitas Dev/Sounds Good/Outputs/OutputCollection");
            }
            catch (Exception e)
            {
