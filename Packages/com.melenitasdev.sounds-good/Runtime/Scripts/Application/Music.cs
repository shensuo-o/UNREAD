...
//#SG_PRO_END
    ...
    public partial class Music // Public Methods
    {
        ...
        /// <summary>
        /// Set my recommended random volume. Range is (0.8, 1). It's useful to avoid music be repetitive.
        /// </summary>
        public Music SetRandomVolume ()
        {
        ...
        /// <summary>
        /// Set random volume between given range. It's useful to avoid music be repetitive.
        /// </summary>
        /// <param name="minVolume">Minimum volume</param>
        /// <param name="maxVolume">Maximum volume</param>
        public Music SetRandomVolume (float minVolume, float maxVolume)
        {
...
//#SG_PRO_BEGIN
        /// <summary>
        /// Choose whether this music follows <c>Time.timeScale</c> (<see cref="TimeMode.Scaled"/>)
        /// or ignores it (<see cref="TimeMode.Unscaled"/>, the default). Unscaled keeps it playing at
        /// normal speed while the game is paused or in slow/fast motion — usually what you want for music.
        /// </summary>
        public Music SetTimeMode (TimeMode timeMode)
        {
...
//#SG_PRO_BEGIN
        ...
        public Music SetEffect (Effect effect, float intensity = 1f)
        {
        ...
        /// <param name="intensity">How much of the effect to apply: 0 none, 1 the effect
        /// exactly as you saved it. Values in between scale it down gradually.</param>
        public Music SetEffect (string effectTag, float intensity = 1f)
        {
        ...
        /// <summary>
        /// Change the current effect's intensity while the music is playing, optionally over a lerp
        ...
        /// <summary>
        /// Swap the effect while the music is playing and lerp its intensity to the given value.
        /// </summary>
        /// <param name="effect">Effect tag created in the Effect Creator.</param>
        ...
        /// <summary>
        /// Swap the effect (by tag) while the music is playing and lerp its intensity to the value.
        /// </summary>
        /// <param name="effectTag">Effect tag created in the Effect Creator.</param>
        /// <param name="intensity">Target intensity: 0 none, 1 the effect exactly as saved.</param>
        /// <param name="lerpTime">Time in seconds to lerp the effect in (0 = instant).</param>
